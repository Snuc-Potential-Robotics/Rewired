...
export default function HomePage() {
  ...
  useEffect(() => {
    ...
    // Polling interval to automatically detect when admin starts or ends the CTF
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background text-foreground">
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
          ...
          <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
            <div className="space-y-2.5 max-w-2xl">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-primary/10 border border-primary/20 text-primary text-xs font-mono font-medium">
                ...
                Autonomous Systems & Cybernetics Security
              </div>
              <h1 className="text-3xl sm:text-4xl font-extrabold tracking-tight text-foreground font-mono">
                REWIRED <span className="text-primary">CTF 2026</span>
              </h1>
              <p className="text-sm sm:text-base text-muted-foreground leading-relaxed">
                30-Minute High-Intensity Capture The Flag event organized by the{" "}
                <span className="text-foreground font-medium">SNUC Potential Robotics Club</span>.
                Deconstruct firmware, sniff CAN telemetry, exploit rover APIs, and dominate the dynamic leaderboard.
              </p>
            </div>
        ...
        {/* Category Filter Tabs & Status Notice */}
        ...
        {/* Challenges Area with Pre-Contest Blur Effect */}
              ...
              <div className="max-w-md w-full p-8 rounded-2xl bg-card/90 border border-border/80 shadow-2xl backdrop-blur-md text-center space-y-4">
                ...
                <div className="space-y-2">
                  <h2 className="text-xl font-bold tracking-tight text-foreground font-mono">
                    CTF Starts in a Few Minutes
                  </h2>
                  <p className="text-xs text-muted-foreground leading-relaxed">
                    Challenge payloads and instructions are encrypted. The 30-minute competition timer will begin as soon as the administrator initiates the launch signal.
                  </p>
                </div>
                ...
                {!team ? (
                  ...
                  <div className="text-xs text-muted-foreground">
                    Team <span className="font-semibold text-primary">{team.name}</span> is registered and ready on standby.
                  </div>
                )}
              </div>
            </div>
            ...
            <div className="mb-6 p-4 rounded-xl bg-secondary border border-border flex items-center justify-between gap-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-xs text-muted-foreground">
                    The 30-minute competition has concluded. Check out the top 3 champions and full standings.
                  </div>
                </div>
              </div>
              <Link
              ...
              >
                ...
                <div className="pt-4 mt-4 border-t border-border/70 flex items-center justify-between text-xs">
                  ...
                  <span className="font-semibold text-[11px] text-primary group-hover:translate-x-0.5 transition-transform flex items-center gap-1">
                    {q.isSolved ? "View Solution" : "Solve Challenge"}
